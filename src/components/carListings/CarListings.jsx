...
const CarListing = () => {
  return (
    <div className="bg-gray-100 p-4 sm:p-6 py-10">
      <h2 className="font-bold text-gray-700 mb-2 text-xl">
        Most recent cars for sale in Bangladesh
      </h2>
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <Link
          to="/car-listings"
          className="bg-green-600 text-white rounded-lg flex flex-col justify-center items-center shadow-md p-4 sm:p-6"
        >
